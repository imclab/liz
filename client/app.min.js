...
var EventScheduler=React.createClass({displayName:"EventScheduler",STEPS:["form","select","confirm","done"],DURATIONS:[{value:"30 min"},{value:"1 hour"},{value:"1 hour 30 mins"},{value:"2 hours"},{value:"4 hours"},{value:"8 hours"}],FIELDS:["summary","attendees","duration","location","description","start","end"],MAX_TIMESLOTS:10,getInitialState:function(){var t=this.props.user;this.DEFAULT={summary:"New Event",attendees:t.email||"",duration:"2 hours",location:"",description:"",start:"",end:""},hash.onChange("step",function(t){t!=this.state.step&&this.isMounted()&&this.setState({step:t})}.bind(this));var e={step:hash.get("step")||this.STEPS[0],contacts:[this.getOwnContact()],freeBusy:null,timeslots:null,limitTimeslots:!0,loadingTimeslots:!1,error:null};return this.FIELDS.forEach(function(t){e[t]=this.getStore(t)}.bind(this)),e},render:function(){switch(this.state.step){case"select":return this.renderSelect();case"confirm":return this.renderConfirm();case"done":return this.renderDone();default:return this.renderForm()}},renderBreadcrumb:function(){return React.DOM.div(null,React.DOM.ol({className:"breadcrumb breadcrumb-arrow"},React.DOM.li(null,React.DOM.a({href:"#"},"Input")),React.DOM.li(null,React.DOM.a({href:"#"},"Date selection")),React.DOM.li({className:"active"},"Confirmation")))},renderForm:function(){var t=this.state.duration,e=this.DURATIONS;return-1==e.indexOf(t)&&e.push({value:t}),React.DOM.div({className:"scheduler"},React.DOM.form({onSubmit:this.handleSubmit},React.DOM.table(null,React.DOM.colgroup(null,React.DOM.col({width:"100px"})),React.DOM.tr(null,React.DOM.th(null,"Title"),React.DOM.td(null,React.DOM.input({type:"text",className:"form-control",name:"summary",ref:"summary",value:this.state.summary,onChange:this.handleTextChange}))),React.DOM.tr(null,React.DOM.th(null,"Attendees ",this.renderPopover("Attendees","Select one or multiple attendees. You can select individuals and/or team members.")),React.DOM.td(null,Selectize({ref:"attendees",className:"form-control",value:this.state.attendees,options:this.state.contacts,create:!0,createOnBlur:!0,multiple:!0,placeholder:"Select one or multiple attendees...",searchField:["name","email"],sortField:"text",labelField:"text",valueField:"email",hideSelected:!0,onChange:this.handleAttendeesChange}))),React.DOM.tr(null,React.DOM.th(null,"Duration ",this.renderPopover("Duration",'Choose a duration from the dropdown, or enter your own custom duration like "45min" or "1h 15m".')),React.DOM.td(null,Selectize({ref:"duration",className:"form-control",value:t,multipe:!1,create:!0,createOnBlur:!0,options:e,placeholder:"Select a duration...",labelField:"value",onChange:this.handleDurationChange}))),React.DOM.tr(null,React.DOM.th(null,"Location"),React.DOM.td(null,React.DOM.input({type:"text",className:"form-control",name:"location",ref:"location",value:this.state.location,onChange:this.handleTextChange}))),React.DOM.tr(null,React.DOM.th(null,"Description"),React.DOM.td(null,React.DOM.textarea({className:"form-control",name:"description",ref:"description",value:this.state.description,onChange:this.handleTextChange})))),React.DOM.p(null,React.DOM.input({type:"submit",className:"btn btn-primary",value:"Find a date"}))))},renderSelect:function(){var t=this.state.error&&React.DOM.p({className:"error"},this.state.error.toString()),e=this.state.freeBusy&&this.state.freeBusy.errors;if(void 0==t&&void 0!=e&&e.length>0){var a=e.map(function(t){return t.id});t=React.DOM.p({className:"error"},"Error: Could not retrieve the availablility of all attendees. The following dates are calculated without the availability of ",React.DOM.b(null,a.join(", ")),".")}var s=null;if(this.state.timeslots){var n=this.state.start,i=this.state.end,r=-1;findIndex(this.state.timeslots,function(t){return t.start==n&&t.end==i});var o=-1!=r?r:null;s=this.state.timeslots.length>0?TimeslotList({ref:"timeslots",timeslots:this.state.limitTimeslots?this.state.timeslots.slice(0,this.MAX_TIMESLOTS):this.state.timeslots,value:o,onChange:this.handleTimeslotChange}):React.DOM.p({className:"error"},"Sorry, there is no suitable date found to plan this event.")}var l,c=this.state.loadingTimeslots&&React.DOM.p({className:"loading"},"Calculating dates ",React.DOM.img({src:"img/ajax-loader.gif"})),u=React.DOM.button({onClick:this.back,className:"btn btn-normal"},"Back");if(null!=this.state.timeslots){var h=this.isLimited()?"Display more dates":"Search for dates after "+this.state.timeMax.format("YYYY-MM-DD");l=null!=this.state.timeslots&&React.DOM.button({className:"btn btn-primary",title:h,onClick:this.findMoreTimeslots},"Find more dates")}var m=React.DOM.p(null,u," ",l);return React.DOM.div({className:"scheduler"},React.DOM.p(null,"Select any of the available dates for ",React.DOM.b(null,this.state.summary," (",juration.stringify(juration.parse(this.state.duration)),")"),":"),t,s,c,m)},renderConfirm:function(){var t=this.state.creating?React.DOM.span({className:"loading"},"Creating event... ",React.DOM.img({src:"img/ajax-loader.gif"})):React.DOM.span(null);return React.DOM.div({className:"scheduler"},React.DOM.p(null,"Summary:"),this.renderEvent(),null!=this.state.error?React.DOM.p({className:"error"},this.state.error.toString()):"",React.DOM.p(null,React.DOM.button({onClick:this.back,className:"btn btn-normal"},"Back")," ",React.DOM.button({onClick:this.create,className:"btn btn-primary",disabled:this.state.creating},"Create the event")," ",t))},renderDone:function(){return React.DOM.div({className:"scheduler"},React.DOM.p(null,"The event is created."),this.renderEvent(),React.DOM.p(null,React.DOM.button({onClick:this.done,className:"btn btn-primary"},"Done")))},renderEvent:function(){return React.DOM.table({className:"dates"},React.DOM.tr(null,React.DOM.th(null,"Title"),React.DOM.td(null,this.state.summary)),React.DOM.tr(null,React.DOM.th(null,"Attendees"),React.DOM.td(null,this.renderAttendees())),React.DOM.tr(null,React.DOM.th(null,"Time"),React.DOM.td(null,formatHumanDate(this.state.start)," ",formatTime(this.state.start)," – ",formatTime(this.state.end))),React.DOM.tr(null,React.DOM.th(null,"Location"),React.DOM.td(null,this.state.location)),React.DOM.tr(null,React.DOM.th(null,"Description"),React.DOM.td(null,this.state.description)))},renderAttendees:function(){return this.state.attendees.split(",").map(function(t){var e=this.getContact(t);return React.DOM.div(null,e.name?e.name+" <"+e.email+">":e.email)}.bind(this))},renderPopover:function(t,e,a){return React.DOM.a({href:"#",onClick:function(t){t.preventDefault()}},React.DOM.span({"data-toggle":"popover","data-placement":a||"top",title:t,"data-content":e,className:"glyphicon glyphicon-info-sign","aria-hidden":"true"}))},back:function(){var t=this.STEPS.indexOf(this.state.step),e=this.STEPS[t-1];e&&this.setState({step:e})},done:function(){this.setStore(this.DEFAULT),this.setState(this.DEFAULT),this.setState({step:this.STEPS[0]})},handleSubmit:function(t){t.preventDefault();var e=this.prehistoricFormValidation();return e?void alert(e):void this.setState({step:"select"})},handleDurationChange:function(t){this.setStore({duration:t}),this.setState({duration:t})},handleAttendeesChange:function(t){this.setStore({attendees:t||""}),this.setState({attendees:t||""})},handleTextChange:function(){var t={summary:this.refs.summary.getDOMNode().value,location:this.refs.location.getDOMNode().value,description:this.refs.description.getDOMNode().value};this.setStore(t),this.setState(t)},handleTimeslotChange:function(t){var e=this.state.timeslots[t];this.setState({step:"confirm",start:e.start,end:e.end}),this.setStore({start:e.start,end:e.end})},prehistoricFormValidation:function(){if(!this.state.summary||""==this.state.summary.trim())return Error("Title is empty");var t=this.state.attendees;if(!t||""==t.trim())return new Error("Attendees is empty");var e=this.state.duration,a=!1;try{juration.parse(e),a=!0}catch(s){}return e&&""!=e.trim()&&a?void 0:new Error("No valid duration")},getContact:function(t){if(this.state.contacts){var e=this.state.contacts.filter(function(e){return e.email==t})[0];if(e)return e}return{email:t}},loadContacts:function(){Promise.all([ajax.get("/contacts"),ajax.get("/groups")]).then(function(t){var e=t[0],a=t[1];console.log("contacts",e),console.log("groups",a);var s=e.map(function(t){return{name:t.name,email:t.email,text:t.name?t.name+" <"+t.email+">":t.email}});a.forEach(function(t){var e=s.some(function(e){return e.email==t.name});e||s.push({name:t.name,email:t.id,text:t.name})});var n=s.some(function(t){return t.email==this.props.user.email}.bind(this));n||s.push(this.getOwnContact()),this.setState({contacts:s})}.bind(this)).catch(function(t){console.log(t),displayError(t)}.bind(this))},create:function(){this.setState({creating:!0,error:null});var t=this.props.user.email,e={attendees:this.state.attendees.split(",").map(function(t){var e=this.getContact(t);return{email:e.email,displayName:e.name}}.bind(this)),summary:this.state.summary,location:this.state.location,description:this.state.description,start:{dateTime:this.state.start},end:{dateTime:this.state.end}};console.log("event",e),ajax.put("/calendar/"+t,e).then(function(t){console.log("event created",t),this.setState({creating:!1,step:"done"})}.bind(this)).catch(function(t){console.log(t),this.setState({error:t,creating:!1})}.bind(this))},componentDidMount:function(){this.initStep(),$('[data-toggle="popover"]').popover()},componentDidUpdate:function(t,e){e.step!==this.state.step&&(hash.set({step:this.state.step}),this.initStep()),$('[data-toggle="popover"]').popover()},initStep:function(){if("form"==this.state.step&&(this.selectSummary(),this.loadContacts()),"select"==this.state.step){var t=moment(),e=moment(new Date(t.year(),t.month(),t.date())),a=e.clone().add(14,"days");this.setState({timeMin:e,timeMax:a,timeslots:null,limitTimeslots:!0,error:null}),this.findTimeslots(e,a)}},getOwnContact:function(){var t=this.props.user;return{name:t.name,email:t.email,text:t.name+" <"+t.email+">"}},findTimeslots:function(t,e){this.setState({loadingTimeslots:!0,error:null});var a="/freeBusy/?calendars="+encodeURIComponent(this.state.attendees)+"&timeMin="+t.toISOString()+"&timeMax="+e.toISOString();return ajax.get(a).then(function(t){console.log("freeBusy",t);var e=t.free||[],a=1e3*juration.parse(this.state.duration),s=intervals.generateTimeslots(e,a);console.log("timeslots",s),this.setState({timeslots:s,freeBusy:t,loadingTimeslots:!1,error:null})}.bind(this)).catch(function(t){this.setState({loadingTimeslots:!1,error:t}),console.log(t)}.bind(this))},findMoreTimeslots:function(){if(this.isLimited())this.setState({limitTimeslots:!1});else{var t=this.state.timeMin,e=this.state.timeMax.clone().add(14,"days");this.setState({limitTimeslots:!1,timeMax:e}),this.findTimeslots(t,e)}},isLimited:function(){return this.state.limitTimeslots&&null!=this.state.timeslots&&this.state.timeslots.length>this.MAX_TIMESLOTS},selectSummary:function(){this.refs.summary&&this.refs.summary.getDOMNode().select()},getStore:function(t){var e=localStorage[t];return void 0!==e?e:this.DEFAULT[t]},setStore:function(t,e){"string"==typeof t?localStorage[t]=e.toString():Object.keys(t).forEach(function(e){localStorage[e]=t[e].toString()})}});
