...
var App=React.createClass({displayName:"App",getInitialState:function(){return this.loadUser(),{user:null,page:hash.get("page")||"home"}},render:function(){var e,t=this.state.user,a=Menu({ref:"menu",user:t,page:this.state.page,onPage:this.handlePageChange});if(t&&1==t.loggedIn)switch(this.state.page){case"settings":e=SettingsPage({ref:"page",user:this.state.user,onChange:this.handleUserChange});break;case"calendar":e=CalendarPage({ref:"page",user:this.state.user});break;default:e=HomePage({ref:"page",user:this.state.user})}else e=t&&0==t.loggedIn?React.DOM.div(null,React.DOM.h1(null,"Sign in to get started..."),React.DOM.p(null,React.DOM.a({href:"/user/signin?redirectTo="+encodeURIComponent(location.href),className:"btn btn-primary"},"Sign in"))):React.DOM.div(null,"loading ",React.DOM.img({className:"loading",src:"img/ajax-loader.gif"}));return React.DOM.div(null,a,e)},handlePageChange:function(e){hash.set("page",e),this.setState({page:e})},handleUserChange:function(e){console.log("Changed user:",e),this.setState({user:e}),ajax.put("/user/",e).then(function(e){console.log("user",e),this.setState({user:e})}.bind(this)).catch(function(e){console.log("Error",e)})},loadUser:function(){ajax.get("/user/").then(function(e){console.log("user",e),this.setState({user:e})}.bind(this)).catch(function(e){console.log("Error",e)})}});
