...
var SettingsPage=React.createClass({displayName:"SettingsPage",SHARE:[{value:"calendar",text:"Everyone with access to my calendar"},{value:"contacts",text:"All my contacts"},{value:"everybody",text:"Everybody"}],getInitialState:function(){return this.loadCalendarList(),this.loadGroupsList(),this.loadProfiles(),{loading:!0,user:this.props.user,profiles:null,profilesError:null,calendarList:[],calendarListError:null,calendarListLoading:!0,groupsList:[],showHelpAvailability:!1,showHelpBusy:!1}},render:function(){var t;return t=this.state.loading?React.DOM.div(null,React.DOM.h1(null,"Settings"),React.DOM.div(null,"loading ",React.DOM.img({className:"loading",src:"img/ajax-loader.gif"}))):this.state.profilesError?React.DOM.p({className:"error"},this.state.profilesError.toString()):this.renderProfiles(),React.DOM.div(null,React.DOM.h1(null,"Settings"),React.DOM.h2(null,"Availability profiles"),React.DOM.p(null,"Create one or multiple profiles to specify when you are available and in what role."),t,Profile({ref:"profile",groups:this.getGroupOptions(),calendars:this.getCalendarOptions(),onChange:this.handleProfileChange}),React.DOM.h2(null,"Sharing"),React.DOM.p(null,"Who is allowed to view your free/busy profile and plan events in your calendar via Liz?"),Selectize({value:this.state.user.share,options:this.SHARE,onChange:this.handleShareSelection}),React.DOM.h2(null,"Account"),React.DOM.p(null,"Remove your account at Liz."),React.DOM.p(null,React.DOM.button({onClick:this.deleteAccount,className:"btn btn-danger"},"Delete account")))},renderProfiles:function(){var t=(React.DOM.tr({key:"header"},React.DOM.th(null,"Description"),React.DOM.th(null)),this.state.profiles||[]),e=t.map(function(t){var e=t.calendars&&t.calendars.split(",")||[],i=e.map(function(t,i){t=t.trim();var n=this.state.calendarList.filter(function(e){return e.id==t})[0],a=void 0!==n?n.summary:t;return i!=e.length-1&&(a+=", "),React.DOM.span({title:t},a)}.bind(this));return React.DOM.div({key:t._id,className:"profile-entry"},React.DOM.table(null,React.DOM.tbody(null,React.DOM.tr(null,React.DOM.th(null,"Role"),React.DOM.td(null,"group"==t.role?"Team member":"Individual")),"group"==t.role?React.DOM.tr(null,React.DOM.th(null,"Team"),React.DOM.td(null,t.group)):"",React.DOM.tr(null,React.DOM.th(null,"Calendars"),React.DOM.td(null,i)),React.DOM.tr(null,React.DOM.th(null,"Tag"),React.DOM.td(null,t.tag)))),React.DOM.div({className:"menu"},React.DOM.button({className:"btn btn-normal",title:"Edit this profile",onClick:function(){this.editProfile(t._id)}.bind(this)},React.DOM.span({className:"glyphicon glyphicon-pencil"}))," ",React.DOM.button({className:"btn btn-danger",title:"Delete this profile",onClick:function(){this.removeProfile(t._id)}.bind(this)},React.DOM.span({className:"glyphicon glyphicon-remove"}))))}.bind(this));return React.DOM.div(null,e,React.DOM.div(null,React.DOM.button({onClick:this.addProfile,className:"btn btn-normal",title:"Add a new profile"},React.DOM.span({className:"glyphicon glyphicon-plus"})," Add")))},renderProfilesOld:function(){var t=React.DOM.tr({key:"header"},React.DOM.th(null,"Role"),React.DOM.th(null,"Calendars"),React.DOM.th(null,"Tag"),React.DOM.th(null)),e=this.state.profiles||[],i=e.map(function(t){var e=t.calendars&&t.calendars.split(",")||[],i=e.map(function(t,i){t=t.trim();var n=this.state.calendarList.filter(function(e){return e.id==t})[0],a=void 0!==n?n.summary:t;i!=e.length-1&&(a+=",");var l={display:"inline-block",maxWidth:200,overflow:"hidden",textOverflow:"ellipsis",paddingRight:5};return React.DOM.div({style:l,title:t},a)}.bind(this));return React.DOM.tr({key:t._id},React.DOM.td(null,"group"==t.role?"Team: "+t.group:"Individual"),React.DOM.td(null,i),React.DOM.td(null,t.tag),React.DOM.td(null,React.DOM.button({className:"btn btn-normal",title:"Edit this profile",onClick:function(){this.editProfile(t._id)}.bind(this)},React.DOM.span({className:"glyphicon glyphicon-pencil"}))," ",React.DOM.button({className:"btn btn-danger",title:"Delete this profile",onClick:function(){this.removeProfile(t._id)}.bind(this)},React.DOM.span({className:"glyphicon glyphicon-remove"}))))}.bind(this));return React.DOM.div(null,React.DOM.table({className:"table profiles"},React.DOM.tbody(null,t,i,React.DOM.tr({key:"footer"},React.DOM.td({colSpan:"4"},React.DOM.button({onClick:this.addProfile,className:"btn btn-normal",title:"Add a new profile"},React.DOM.span({className:"glyphicon glyphicon-plus"})," Add"))))))},addProfile:function(){var t={_id:UUID(),user:this.props.user.email,calendars:this.props.user.email||"",tag:"#available",role:"individual"};this.refs.profile.show(t)},editProfile:function(t){var e=this.findProfile(t);e&&this.refs.profile.show(e)},removeProfile:function(t){var e=this.findProfile(t);if(console.log("removeProfile",e),void 0!==e&&confirm("Are you sure you want to delete this profile?")){var i=this.state.profiles;i.splice(i.indexOf(e),1),this.setState({profiles:i}),ajax.del("/profiles/"+t).then(function(){}.bind(this)).catch(function(t){console.log(t),displayError(t)}.bind(this))}},findProfile:function(t){var e=this.state.profiles;return e.filter(function(e){return e._id==t})[0]},saveProfile:function(t){var e=t._id;void 0===e&&(e=UUID(),t._id=e),this.timers[e]&&clearTimeout(this.timers[e]);var i=300;this.timers[e]=setTimeout(function(){delete this.timers[e],console.log("saving profile...",t),ajax.put("/profiles",t).then(function(){}.bind(this)).catch(function(t){console.log(t),displayError(t)}.bind(this))}.bind(this),i)},timers:{},handleProfileChange:function(t){console.log("profile changed",t);var e=!1,i=this.state.profiles.map(function(i){return i._id==t._id?(e=!0,t):i});e||i.push(t),this.setState({profiles:i}),this.saveProfile(t)},handleCalendarSelection:function(t){var e=this.state.user;e.calendars=t,this.updateUser(e)},handleShareSelection:function(t){var e=this.state.user;e.share=t,this.updateUser(e)},loadProfiles:function(){ajax.get("/profiles").then(function(t){console.log("profiles",t),this.setState({loading:!1,profiles:t})}.bind(this)).catch(function(t){this.setState({loading:!1,profilesError:t}),console.log(t),displayError(t)}.bind(this))},loadCalendarList:function(){ajax.get("/calendar/").then(function(t){console.log("calendarList",t),this.setState({calendarList:t.items||[],calendarListLoading:!1,calendarListError:null})}.bind(this)).catch(function(t){this.setState({calendarListLoading:!1,calendarListError:t}),console.log(t),displayError(t)}.bind(this))},loadGroupsList:function(){ajax.get("/groups").then(function(t){console.log("groupsList",t),this.setState({groupsList:t})}.bind(this)).catch(function(t){console.log(t),displayError(t)}.bind(this))},getCalendarOptions:function(){var t=this.state.calendarList.concat([]),e=this.state.profiles||[];return e.forEach(function(e){e.calendars&&e.calendars.split(",").forEach(function(e){var i=t.some(function(t){return t.id==e});i||t.push({id:e})})}.bind(this)),t.map(function(t){var e=t.summary||t.id;return e.length>30&&(e=e.substring(0,30)+"..."),{value:t.id,text:e}})},getGroupOptions:function(){return this.state.groupsList.map(function(t){return{value:t.name,text:t.name}}.bind(this))},updateUser:function(t){this.setState({user:t}),"function"==typeof this.props.onChange&&this.props.onChange(t)},deleteAccount:function(){confirm("Are you sure you want to delete your account?\n\nThis action cannot be undone.")&&ajax.del("/user/").then(function(){location.href="/"}).catch(function(t){console.log(t),displayError(t)})},showHelpBusy:function(t){t.preventDefault(),this.setState({showHelpBusy:!0})},showHelpAvailability:function(t){t.preventDefault(),this.setState({showHelpAvailability:!0})}});
