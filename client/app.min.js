...
var SettingsPage=React.createClass({displayName:"SettingsPage",SHARE:[{value:"calendar",text:"Everyone with access to my calendar"},{value:"contacts",text:"All my contacts"},{value:"everybody",text:"Everybody"}],getInitialState:function(){return this.loadCalendarList(),this.loadGroupsList(),this.loadProfiles(),{loading:!0,user:this.props.user,profiles:null,profilesError:null,calendarList:[],calendarListError:null,calendarListLoading:!0,groupsList:[],showHelpAvailability:!1,showHelpBusy:!1}},render:function(){var e;return e=this.state.loading?React.DOM.div(null,React.DOM.h1(null,"Settings"),React.DOM.div(null,"loading ",React.DOM.img({className:"loading",src:"img/ajax-loader.gif"}))):this.state.profilesError?React.DOM.p({className:"error"},this.state.profilesError.toString()):this.renderProfiles(),React.DOM.div(null,React.DOM.h1(null,"Settings"),React.DOM.h2(null,"Availability profiles"),React.DOM.p(null,"Create one or multiple profiles to specify when you are available and in what role."),e,Profile({ref:"profile",roles:this.getRoleOptions(),calendars:this.getCalendarOptions(),onChange:this.handleProfileChange}),React.DOM.h2(null,"Sharing"),React.DOM.p(null,"Who is allowed to view your free/busy profile and plan events in your calendar via Liz?"),Selectize({value:this.state.user.share,options:this.SHARE,onChange:this.handleShareSelection}),React.DOM.h2(null,"Account"),React.DOM.p(null,"Remove your account at Liz."),React.DOM.p(null,React.DOM.button({onClick:this.deleteAccount,className:"btn btn-danger"},"Delete account")))},renderProfiles:function(){var e=React.DOM.tr({key:"header"},React.DOM.th(null,"Role"),React.DOM.th(null,"Calendars"),React.DOM.th(null,"Tag"),React.DOM.th(null)),t=this.state.profiles||[],i=t.map(function(e){var t=e.calendars&&e.calendars.split(",")||[],i=t.map(function(e,i){e=e.trim();var n=this.state.calendarList.filter(function(t){return t.id==e})[0],a=void 0!==n?n.summary:e;i!=t.length-1&&(a+=",");var l={display:"inline-block",maxWidth:200,overflow:"hidden",textOverflow:"ellipsis",paddingRight:5};return React.DOM.div({style:l,title:e},a)}.bind(this));return React.DOM.tr({key:e._id},React.DOM.td(null,e.role),React.DOM.td(null,i),React.DOM.td(null,e.tag),React.DOM.td(null,React.DOM.button({className:"btn btn-normal",title:"Edit this profile",onClick:function(){this.editProfile(e._id)}.bind(this)},React.DOM.span({className:"glyphicon glyphicon-pencil"}))," ",React.DOM.button({className:"btn btn-danger",title:"Delete this profile",onClick:function(){this.removeProfile(e._id)}.bind(this)},React.DOM.span({className:"glyphicon glyphicon-remove"}))))}.bind(this));return React.DOM.div(null,React.DOM.table({className:"table profiles"},React.DOM.tbody(null,e,i,React.DOM.tr({key:"footer"},React.DOM.td({colSpan:"4"},React.DOM.button({onClick:this.addProfile,className:"btn btn-normal",title:"Add a new profile"},React.DOM.span({className:"glyphicon glyphicon-plus"})," Add"))))))},addProfile:function(){var e={_id:UUID(),tag:"#available",role:this.props.user.email||"",calendars:this.props.user.email||""};this.refs.profile.show(e)},editProfile:function(e){var t=this.findProfile(e);t&&this.refs.profile.show(t)},removeProfile:function(e){var t=this.findProfile(e);if(console.log("removeProfile",t),void 0!==t&&confirm('Are you sure you want to delete profile "'+t.name+'"?')){var i=this.state.profiles;i.splice(i.indexOf(t),1),this.setState({profiles:i}),ajax.del("/profiles/"+e).then(function(){}.bind(this)).catch(function(e){console.log(e),displayError(e)}.bind(this))}},findProfile:function(e){var t=this.state.profiles;return t.filter(function(t){return t._id==e})[0]},saveProfile:function(e){var t=e._id;void 0===t&&(t=UUID(),e._id=t),this.timers[t]&&clearTimeout(this.timers[t]);var i=300;this.timers[t]=setTimeout(function(){delete this.timers[t],console.log("saving profile...",e),ajax.put("/profiles",e).then(function(){}.bind(this)).catch(function(e){console.log(e),displayError(e)}.bind(this))}.bind(this),i)},timers:{},handleProfileChange:function(e){console.log("profile changed",e);var t=!1,i=this.state.profiles.map(function(i){return i._id==e._id?(t=!0,e):i});t||i.push(e),this.setState({profiles:i}),this.saveProfile(e)},handleCalendarSelection:function(e){var t=this.state.user;t.calendars=e,this.updateUser(t)},handleShareSelection:function(e){var t=this.state.user;t.share=e,this.updateUser(t)},loadProfiles:function(){ajax.get("/profiles").then(function(e){console.log("profiles",e),this.setState({loading:!1,profiles:e})}.bind(this)).catch(function(e){this.setState({loading:!1,profilesError:e}),console.log(e),displayError(e)}.bind(this))},loadCalendarList:function(){ajax.get("/calendar/").then(function(e){console.log("calendarList",e),this.setState({calendarList:e.items||[],calendarListLoading:!1,calendarListError:null})}.bind(this)).catch(function(e){this.setState({calendarListLoading:!1,calendarListError:e}),console.log(e),displayError(e)}.bind(this))},loadGroupsList:function(){ajax.get("/groups").then(function(e){console.log("groupsList",e),this.setState({groupsList:e})}.bind(this)).catch(function(e){console.log(e),displayError(e)}.bind(this))},getCalendarOptions:function(){var e=this.state.calendarList.concat([]),t=this.state.profiles||[];return t.forEach(function(t){t.calendars&&t.calendars.split(",").forEach(function(t){var i=e.some(function(e){return e.id==t});i||e.push({id:t})})}.bind(this)),e.map(function(e){var t=e.summary||e.id;return t.length>30&&(t=t.substring(0,30)+"..."),{value:e.id,text:t}})},getRoleOptions:function(){var e=this.props.user,t=this.state.groupsList.filter(function(e){var t=e.members&&e.members[0]==e.name;return!t}),i=this.state.profiles||[];i.forEach(function(i){if(i.role){var n=t.some(function(e){return e.name==i.role});n||t.push({name:i.role,count:1,members:[e.email]})}}.bind(this));var n=t.some(function(t){return t.name==e.email});return n||t.push({name:e.email,count:1,members:[e.email]}),t.map(function(e){return{value:e.name,text:e.name}}.bind(this))},updateUser:function(e){this.setState({user:e}),"function"==typeof this.props.onChange&&this.props.onChange(e)},deleteAccount:function(){confirm("Are you sure you want to delete your account?\n\nThis action cannot be undone.")&&ajax.del("/user/").then(function(){location.href="/"}).catch(function(e){console.log(e),displayError(e)})},showHelpBusy:function(e){e.preventDefault(),this.setState({showHelpBusy:!0})},showHelpAvailability:function(e){e.preventDefault(),this.setState({showHelpAvailability:!0})}});
