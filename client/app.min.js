...
function identicalArray(e,t){return e.length===t.length&&!e.some(function(e,i){return t[i]!==e})}var Selectize=React.createClass({displayName:"Selectize",getDefaultProps:function(){return{disabled:!1,multiple:!1,placeholder:"Select an option...",value:"",handleChange:$.noop}},getValue:function(){return this.selectize.getValue()},create:function(){var e=this,t={};selectizeOptNames.forEach(function(i){i in e.props&&(t[i]=e.props[i])}),this.selectize=$(this.refs.select.getDOMNode()).selectize(t)[0].selectize,this.selectize.setValue(this.props.value),this.selectize.on("change",this.handleChange)},destroy:function(){this.selectize.destroy()},shouldComponentUpdate:function(e){var t=this,i=Object.keys(e).some(function(i){return i in handledProps?!1:e[i]!==t.props[i]});return i?!0:(this._updating=!0,e.disabled!==this.props.disabled&&(e.disabled?this.selectize.disable():this.selectize.enable()),e.placeholder!==this.props.placeholder&&(this.selectize.settings.placeholder=e.placeholder,this.selectize.updatePlaceholder()),e.options===this.props.options||identicalArray(this.props.options,e.options)||(this.selectize.clearOptions(),e.options.forEach(function(e){t.selectize.addOption(e)}),this.selectize.refreshOptions(!1)),e.value!==this.props.value&&(e.multiple&&null!==e.value?identicalArray(e.value,this.getValue())||this.selectize.setValue(e.value):e.value!==this.getValue()&&this.selectize.setValue(e.value)),this._updating=!1,!1)},handleChange:function(e){setTimeout(function(){this._updating||this.props.handleChange(e)}.bind(this),0)},componentDidMount:function(){this.create()},componentWillUnmount:function(){this.destroy()},componentWillUpdate:function(){this.destroy()},componentDidUpdate:function(){this.create()},render:function(){var e={ref:"select",className:"form-control"};return this.props.disabled&&(e.disabled=!0),this.props.multiple&&(e.multiple=!0),React.DOM.div({className:"form-group"},React.DOM.select(e))}});const selectizeOptNames=["delimiter","diacritics","create","createOnBlur","createFilter","highlight","persist","openOnFocus","maxOptions","maxItems","hideSelected","scrollDuration","loadThrottle","preload","dropdownParent","addPrecedence","selectOnTab","options","dataAttr","valueField","optgroupValueField","labelField","optgroupLabelField","optgroupField","sortField","searchField","searchConjunction","optgroupOrder","load","score","render","placeholder"];var handledProps={value:!0,disabled:!0,placeholder:!0,handleChange:!0,options:!0};
...
var SettingsPage=React.createClass({displayName:"SettingsPage",getInitialState:function(){return this.loadCalendarList(),this.loadGroups(),{user:this.props.user,calendars:null,calendarsError:null,groups:null,groupsError:null}},render:function(){return React.DOM.div(null,React.DOM.h1(null,"Settings"),React.DOM.h2(null,"Sharing"),React.DOM.p(null,"Who is allowed to view your free/busy profile and plan events in your calendar via Liz?"),React.DOM.select({value:this.state.user.share,onChange:this.handleShareSelection},React.DOM.option({value:"calendar"},"Everyone with access to my calendar"),React.DOM.option({value:"contacts"},"All my contacts"),React.DOM.option({value:"everybody"},"Everybody")),React.DOM.h2(null,"Calendars"),React.DOM.p(null,"Select which of your calendars will be used to generate your free/busy profile:"),this.renderCalendarList(),React.DOM.h2(null,"Teams"),React.DOM.p(null,"Add yourself to relevant teams. You can create new teams."),this.renderGroups(),React.DOM.h2(null,"Availability profile"),React.DOM.p(null,"Select one of your calendars as availability profile. Fill this calendar with (repeating) events describing your availability. This can for example be your working hours, like Monday to Friday 9:00-18:00."),React.DOM.p(null,"(not yet implemented...)"),React.DOM.h2(null,"Account"),React.DOM.p(null,React.DOM.button({onClick:this.deleteAccount,className:"btn btn-danger"},"Delete account")))},renderCalendarList:function(){var e=this.state.user&&this.state.user.calendars||[];return null!=this.state.calendarsError?React.DOM.p({className:"error"},this.state.calendarsError.toString()):null!=this.state.calendars?CalendarList({calendars:this.state.calendars,selection:e,onChange:this.handleCalendarSelection}):React.DOM.div(null,"loading ",React.DOM.img({className:"loading",src:"img/ajax-loader.gif"}))},renderGroups:function(){if(null!=this.state.groupsError)return React.DOM.p({className:"error"},this.state.groupsError.toString());if(null!=this.state.groups){var e=this.state.groups.map(function(e){var t={group:e,count:1,members:[this.state.user.email]};return t.text=this.groupLabel(t),t}.bind(this));return Selectize({ref:"teams",load:this.loadGroupList,options:e,value:this.state.groups,create:!0,createOnBlur:!0,multiple:!0,placeholder:"Select one or multiple teams...",searchField:["group"],sortField:"text",labelField:"text",valueField:"group",hideSelected:!0,handleChange:this.handleGroupChange})}return React.DOM.div(null,"loading ",React.DOM.img({className:"loading",src:"img/ajax-loader.gif"}))},handleCalendarSelection:function(e){var t=this.state.user;t.calendars=e,this.updateUser(t)},handleShareSelection:function(e){var t=this.state.user;t.share=e.target.value,this.updateUser(t)},loadCalendarList:function(){ajax.get("/calendar/").then(function(e){console.log("calendars",e),this.setState({calendars:e.items||[]})}.bind(this)).catch(function(e){this.setState({calendarsError:e}),console.log(e)}.bind(this))},loadGroups:function(){ajax.get("/groups").then(function(e){console.log("groups",e),this.setState({groups:e})}.bind(this)).catch(function(e){this.setState({groupsError:e}),console.log(e)}.bind(this))},loadGroupList:function(e,t){return this.options?t(this.options):(console.log("load all groups..."),void ajax.get("/groups/list").then(function(e){console.log("all groups",e),this.options=e.map(function(e){return{group:e.group,text:this.groupLabel(e)}}.bind(this)),t(this.options)}.bind(this)).catch(function(e){this.options=[],t(this.options),console.log(e),displayError(e)}.bind(this)))},handleGroupChange:function(e){ajax.put("/groups",e||[]).then(function(){}.bind(this)).catch(function(e){console.log(e),displayError(e)}.bind(this))},groupLabel:function(e){return e.group},updateUser:function(e){this.setState({user:e}),"function"==typeof this.props.onChange&&this.props.onChange(e)},deleteAccount:function(){confirm("Are you sure you want to delete your account?\n\nThis action cannot be undone.")&&ajax.del("/user/").then(function(){location.href="/"}).catch(function(e){console.log(e),displayError(e)})}});
