...
var SettingsPage=React.createClass({displayName:"SettingsPage",SHARE:[{value:"calendar",text:"Everyone with access to my calendar"},{value:"contacts",text:"All my contacts"},{value:"everybody",text:"Everybody"}],getInitialState:function(){return this.loadCalendarList(),this.loadGroupsList(),this.loadGroups(),{loading:!0,user:this.props.user,groups:null,groupsError:null,calendarList:[],groupsList:[]}},render:function(){var t;if(this.state.loading)t=React.DOM.div(null,React.DOM.h1(null,"Settings"),React.DOM.div(null,"loading ",React.DOM.img({className:"loading",src:"img/ajax-loader.gif"})));else{if(this.state.groupsError)return React.DOM.p({className:"error"},this.state.groupsError.toString());try{t=this.renderAvailabilityTable()}catch(e){console.log(e)}}return React.DOM.div(null,React.DOM.h1(null,"Settings"),React.DOM.h2(null,"Availability profile"),React.DOM.p(null,"Specify when you are available an in what role. To mark yourself as available, create (recurring) events in your calendar having the specified tag as event title."),t,React.DOM.h2(null,"Calendars"),React.DOM.p(null,"Select which of your calendars will be used to generate your busy profile:"),this.renderCalendarList(),React.DOM.h2(null,"Sharing"),React.DOM.p(null,"Who is allowed to view your free/busy profile and plan events in your calendar via Liz?"),Selectize({value:this.state.user.share,options:this.SHARE,onChange:this.handleShareSelection}),React.DOM.h2(null,"Account"),React.DOM.p(null,React.DOM.button({onClick:this.deleteAccount,className:"btn btn-danger"},"Delete account")))},renderCalendarList:function(){var t=this.state.user&&this.state.user.calendars||[];return null!=this.state.calendarListError?React.DOM.p({className:"error"},this.state.calendarListError.toString()):null!=this.state.calendarList?CalendarList({calendars:this.state.calendarList,selection:t,onChange:this.handleCalendarSelection}):React.DOM.div(null,"loading ",React.DOM.img({className:"loading",src:"img/ajax-loader.gif"}))},renderAvailabilityTable:function(){var t=(this.state.calendarList,this.getCalendarOptions()),e=this.getGroupOptions(),a=React.DOM.tr({key:"header"},React.DOM.th(null,"Calendar"),React.DOM.th(null,"Tag"),React.DOM.th(null,"Role (optional)"),React.DOM.th(null)),n=this.state.groups.map(function(a,n){return React.DOM.tr({key:a._id||"new"},React.DOM.td(null,Selectize({options:t,value:a.calendar,placeholder:"Select a calendar...",onChange:function(t){this.handleGroupChange(n,"calendar",t)}.bind(this)})),React.DOM.td(null,React.DOM.input({type:"text",className:"form-control",value:a.tag,placeholder:"Event title...",onChange:function(t){this.handleGroupChange(n,"tag",t.target.value)}.bind(this)})),React.DOM.td(null,Selectize({value:a.group,options:e,create:!0,createOnBlur:!0,placeholder:"Select a role...",onChange:function(t){this.handleGroupChange(n,"group",t)}.bind(this)})),React.DOM.td(null,React.DOM.button({className:"btn btn-danger",title:"Delete this row",onClick:function(){this.removeGroup(a._id)}.bind(this)},"×")))}.bind(this));return React.DOM.div(null,React.DOM.table({className:"table"},React.DOM.colgroup(null,React.DOM.col({width:"30%"}),React.DOM.col({width:"30%"}),React.DOM.col({width:"30%"}),React.DOM.col({width:"10%"})),React.DOM.tbody(null,a,n,React.DOM.tr({key:"footer"},React.DOM.td({colSpan:"4"},React.DOM.button({onClick:this.addGroup,className:"btn btn-primary",title:"Add a new row"},"Add"))))))},handleGroupChange:function(t,e,a){var n=this.state.groups.slice(0),i=_.extend({},n[t]);i[e]=a,n[t]=i,this.setState({groups:n}),this.updateGroup(i)},addGroup:function(){var t=this.state.groups.slice(0);t.push({_id:UUID(),tag:"Available",calendar:this.props.user.email||"",group:""}),this.setState({groups:t})},removeGroup:function(t){var e=this.state.groups,a=e.filter(function(e){return e._id==t})[0];console.log("removeGroup",a),void 0!==a&&(e.splice(e.indexOf(a),1),this.setState({groups:e}),ajax.del("/groups/"+t).then(function(){}.bind(this)).catch(function(t){console.log(t),displayError(t)}.bind(this)))},updateGroup:function(t){var e=t._id;this.timers[e]&&clearTimeout(this.timers[e]);var a=300;this.timers[e]=setTimeout(function(){delete this.timers[e],console.log("saving group...",t),ajax.put("/groups",t).then(function(){}.bind(this)).catch(function(t){console.log(t),displayError(t)}.bind(this))}.bind(this),a)},timers:{},handleCalendarSelection:function(t){var e=this.state.user;e.calendars=t,this.updateUser(e)},handleShareSelection:function(t){var e=this.state.user;e.share=t,this.updateUser(e)},loadGroups:function(){ajax.get("/groups").then(function(t){console.log("groups",t),this.setState({loading:!1,groups:t})}.bind(this)).catch(function(t){this.setState({loading:!1,groupsError:t}),console.log(t)}.bind(this))},loadCalendarList:function(){ajax.get("/calendar/").then(function(t){console.log("calendarList",t),this.setState({calendarList:t.items||[],calendarListError:null})}.bind(this)).catch(function(t){console.log(t),displayError(t),this.setState({calendarListError:t})}.bind(this))},loadGroupsList:function(){ajax.get("/groups/list").then(function(t){console.log("groupsList",t),this.setState({groupsList:t})}.bind(this)).catch(function(t){console.log(t),displayError(t)}.bind(this))},getCalendarOptions:function(){var t=this.state.calendarList.concat([]);return this.state.groups.forEach(function(e){if(e.calendar){var a=t.some(function(t){return t.id==e.calendar});a||t.push({id:e.calendar})}}.bind(this)),t.map(function(t){var e=t.summary||t.id;return e.length>30&&(e=e.substring(0,30)+"..."),{value:t.id,text:e}})},getGroupOptions:function(){var t=this.state.groupsList;return this.state.groups.forEach(function(e){if(e.group){var a=t.some(function(t){return t.name==e.group});a||t.push({name:e.group,count:1,members:[this.props.user.email]})}}.bind(this)),t.map(function(t){return{value:t.name,text:t.name}}.bind(this))},updateUser:function(t){this.setState({user:t}),"function"==typeof this.props.onChange&&this.props.onChange(t)},deleteAccount:function(){confirm("Are you sure you want to delete your account?\n\nThis action cannot be undone.")&&ajax.del("/user/").then(function(){location.href="/"}).catch(function(t){console.log(t),displayError(t)})}});
