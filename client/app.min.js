...
var AvailabilityWizard=React.createClass({displayName:"AvailabilityWizard",DAYS:["Monday","Tuesday","Wednesday","Thursday","Friday","Saturday","Sunday"],getInitialState:function(){var a={calendar:null,tag:"#available"};return this.DAYS.forEach(function(t){a[t]="Saturday"==t||"Sunday"==t?{enabled:!1,start:"",end:""}:{enabled:!0,start:"09:00",end:"17:00"}}),a},render:function(){var a=this.DAYS.map(function(a){return React.DOM.tr({key:a},React.DOM.td(null,React.DOM.label(null,React.DOM.input({type:"checkbox",checked:this.state[a].enabled,onChange:function(t){this.handleChange(a,"enabled",t.target.checked)}.bind(this)})," ",a)),React.DOM.td(null,React.DOM.input({type:"text",className:"form-control",title:"Start time",value:this.state[a].start,onChange:function(t){this.handleChange(a,"start",t.target.value)}.bind(this)})),React.DOM.td(null,React.DOM.input({type:"text",className:"form-control",title:"End time",value:this.state[a].end,onChange:function(t){this.handleChange(a,"end",t.target.value)}.bind(this)})))}.bind(this)),t=this.props.calendars||[],e=t.map(function(a){return{value:a.id,text:a.summary}}),l=null==this.state.calendar?this.props.defaultCalendar:this.state.calendar;return React.DOM.div({className:"modal",ref:"wizard"},React.DOM.div({className:"modal-dialog"},React.DOM.div({className:"modal-content"},React.DOM.div({className:"modal-header"},React.DOM.button({type:"button",className:"close","data-dismiss":"modal","aria-hidden":"true"},"×"),React.DOM.h4({className:"modal-title"},"Availability profile")),React.DOM.div({className:"modal-body"},React.DOM.p(null,"Generate an availability profile in one of your calendars."),React.DOM.h5(null,"Availability"),React.DOM.p(null,"Which days are you available?"),React.DOM.table({className:"availability"},React.DOM.tbody(null,a)),React.DOM.h5(null,"Calendar"),React.DOM.p(null,"In which calendar do you want to create the availability profile?"),Selectize({value:l,options:e,placeholder:"Select a calendar...",onChange:this.handleCalendarChange}),React.DOM.h5(null,"Tag"),React.DOM.p(null,"Which tag do you want to give the availability events?"),React.DOM.input({type:"text",className:"form-control",title:"Availability tag",value:this.state.tag,placeholder:"Enter a tag like '#available'",onChange:this.handleTagChange})),React.DOM.div({className:"modal-footer"},React.DOM.button({type:"button",className:"btn btn-default","data-dismiss":"modal"},"Cancel"),React.DOM.button({type:"button",className:"btn btn-success",onClick:this.create},"Create")))))},show:function(){var a=this.refs.wizard.getDOMNode();$(a).modal("show")},handleChange:function(a,t,e){var l={};l[a]=_.extend({},this.state[a]),l[a][t]=e,this.setState(l)},handleCalendarChange:function(a){this.setState({calendar:a})},handleTagChange:function(a){this.setState({tag:a.target.value})},create:function(){alert("create...")}});
...
var Profile=React.createClass({displayName:"Profile",getInitialState:function(){return{role:"",calendars:"",tag:""}},render:function(){return React.DOM.div({className:"modal",ref:"profile"},React.DOM.div({className:"modal-dialog"},React.DOM.div({className:"modal-content"},React.DOM.div({className:"modal-header"},React.DOM.button({type:"button",className:"close","data-dismiss":"modal","aria-hidden":"true"},"×"),React.DOM.h4({className:"modal-title"},"Availability profile")),React.DOM.div({className:"modal-body"},React.DOM.p(null,"Configure an availability profile."),React.DOM.h5(null,"Role"),React.DOM.p(null,"In which role do you want to be available? You can create new roles. ",this.renderPopover("Role",'Role can be either your own email address, or the name of a team like "Consultant".')),Selectize({value:this.state.role||"",options:this.props.roles,create:!0,createOnBlur:!0,placeholder:"Select a role...",onChange:this.handleRoleChange}),React.DOM.h5(null,"Calendars"),React.DOM.p(null,"Which calendars do you want to take into account to determine your availability? ",this.renderPopover("Calendars","Select one or multiple calendars to determine your availability. These calendars will be used to determine (a) when you are busy, and (b) when you are availability by filtering tagged events.","left")),Selectize({value:this.state.calendars||"",options:this.props.calendars,multiple:"true",placeholder:"Select a calendar...",onChange:this.handleCalendarsChange}),React.DOM.h5(null,"Tag"),React.DOM.p(null,"Which tag do you want to give the availability events? ",this.renderPopover("Tag","All events having the specified tag as title will be used to determine your availability (typically your working hours)")),React.DOM.input({type:"text",className:"form-control",title:"Availability tag",value:this.state.tag||"",placeholder:"Enter a tag like '#available'",onChange:this.handleTagChange})),React.DOM.div({className:"modal-footer"},React.DOM.button({type:"button",className:"btn btn-default","data-dismiss":"modal"},"Cancel"),React.DOM.button({type:"button",className:"btn btn-success",onClick:this.save},"Save")))))},renderPopover:function(e,a,t){return React.DOM.a({href:"#",onClick:function(e){e.preventDefault()}},React.DOM.span({"data-toggle":"popover","data-placement":t||"top",title:e,"data-content":a,className:"glyphicon glyphicon-info-sign","aria-hidden":"true"}))},componentDidMount:function(){$('[data-toggle="popover"]').popover()},componentDidUpdate:function(){$('[data-toggle="popover"]').popover()},handleRoleChange:function(e){this.setState({role:e})},handleCalendarsChange:function(e){this.setState({calendars:e})},handleTagChange:function(e){this.setState({tag:e.target.value})},show:function(e){e&&this.setProfile(e);var a=this.refs.profile.getDOMNode();$(a).modal({keyboard:!1,show:!0})},hide:function(){var e=this.refs.profile.getDOMNode();$(e).modal("hide")},setProfile:function(e){this.setState(e)},getProfile:function(){return _.extend({},this.state)},save:function(){if("function"!=typeof this.props.onChange)throw new Error("onChange handler missing");this.props.onChange(this.getProfile()),this.hide()}});
