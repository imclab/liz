...
var SettingsPage=React.createClass({displayName:"SettingsPage",SHARE:[{value:"calendar",text:"Everyone with access to my calendar"},{value:"contacts",text:"All my contacts"},{value:"everybody",text:"Everybody"}],getInitialState:function(){return this.loadCalendarList(),this.loadGroupsList(),this.loadGroups(),{loading:!0,user:this.props.user,groups:null,groupsError:null,calendarList:[],calendarListError:null,calendarListLoading:!0,groupsList:[],showHelpAvailability:!1,showHelpBusy:!1}},render:function(){var e;if(this.state.loading)e=React.DOM.div(null,React.DOM.h1(null,"Settings"),React.DOM.div(null,"loading ",React.DOM.img({className:"loading",src:"img/ajax-loader.gif"})));else{if(this.state.groupsError)return React.DOM.p({className:"error"},this.state.groupsError.toString());try{e=this.renderAvailabilityTable()}catch(t){console.log(t)}}return React.DOM.div(null,React.DOM.h1(null,"Settings"),React.DOM.h2(null,"Availability profile"),React.DOM.p(null,"Specify roles and tags for availability events. ",this.state.showHelpAvailability?React.DOM.ul(null,React.DOM.li(null,'Specify at least one role. Your default role is your own email address. You can create additional roles like "Consultant" or "Office hour". For each role, specify a tag. This tag can be anything, for example "Available" or "Consultancy".'),React.DOM.li(null,"To mark yourself as available, create (recurring) events in your calendar having the specified tag as event title. You can for example create five recurring events from Monday to Friday, 9:00 to 17:00, to denote your working hours."),React.DOM.li(null,"To check when you are available in a specific role, Liz will filter all events with entered tag as event title from the selected calendar.")):React.DOM.a({href:"#",title:"How does this work?",onClick:this.showHelpAvailability},React.DOM.span({className:"glyphicon glyphicon-question-sign","aria-hidden":"true"}))),e,React.DOM.h2(null,"Calendars"),React.DOM.p(null,"Select which of your calendars will be used to determine your availability. ",this.state.showHelpBusy?React.DOM.span(null,React.DOM.br(null),React.DOM.br(null),"To determine your availability, the calendar events of all selected calendars are retrieved. You are considered available at some timeslot when both:",React.DOM.ul(null,React.DOM.li(null,"the timeslot falls within an availability event: an event having one of the specified availability tags as title."),React.DOM.li(null,"there are no events overlapping with this timeslot."))):React.DOM.a({href:"#",title:"How does this work?",onClick:this.showHelpBusy},React.DOM.span({className:"glyphicon glyphicon-question-sign","aria-hidden":"true"}))),this.renderCalendarList(),React.DOM.h2(null,"Sharing"),React.DOM.p(null,"Who is allowed to view your free/busy profile and plan events in your calendar via Liz?"),Selectize({value:this.state.user.share,options:this.SHARE,onChange:this.handleShareSelection}),React.DOM.h2(null,"Account"),React.DOM.p(null,React.DOM.button({onClick:this.deleteAccount,className:"btn btn-danger"},"Delete account")))},renderCalendarList:function(){var e=this.state.user&&this.state.user.calendars||[];return null!=this.state.calendarListError?React.DOM.p({className:"error"},this.state.calendarListError.toString()):this.state.calendarListLoading?React.DOM.div(null,"loading ",React.DOM.img({className:"loading",src:"img/ajax-loader.gif"})):CalendarList({calendars:this.state.calendarList,selection:e,onChange:this.handleCalendarSelection})},renderAvailabilityTable:function(){var e=this.getGroupOptions(),t=React.DOM.tr({key:"header"},React.DOM.th(null,"Role"),React.DOM.th(null,"Tag"),React.DOM.th(null)),a=this.state.groups.map(function(t,a){return React.DOM.tr({key:t._id||"new"},React.DOM.td(null,Selectize({value:t.group,options:e,create:!0,createOnBlur:!0,placeholder:"Select a role...",onChange:function(e){this.handleGroupChange(a,"group",e)}.bind(this)})),React.DOM.td(null,React.DOM.input({type:"text",className:"form-control",value:t.tag,placeholder:"Event title...",onChange:function(e){this.handleGroupChange(a,"tag",e.target.value)}.bind(this)})),React.DOM.td(null,React.DOM.button({className:"btn btn-danger",title:"Delete this row",onClick:function(){this.removeGroup(t._id)}.bind(this)},"×")))}.bind(this));return React.DOM.div(null,React.DOM.table({className:"table"},React.DOM.colgroup(null,React.DOM.col({width:"50%"}),React.DOM.col({width:"40%"}),React.DOM.col({width:"10%"})),React.DOM.tbody(null,t,a,React.DOM.tr({key:"footer"},React.DOM.td({colSpan:"4"},React.DOM.button({onClick:this.addGroup,className:"btn btn-primary",title:"Add a new row"},"Add"))))))},handleGroupChange:function(e,t,a){var i=this.state.groups.slice(0),n=_.extend({},i[e]);n[t]=a,i[e]=n,this.setState({groups:i}),this.updateGroup(n)},addGroup:function(){var e=this.state.groups.slice(0);e.push({_id:UUID(),tag:"Available",group:this.props.user.email||""}),this.setState({groups:e})},removeGroup:function(e){var t=this.state.groups,a=t.filter(function(t){return t._id==e})[0];console.log("removeGroup",a),void 0!==a&&(t.splice(t.indexOf(a),1),this.setState({groups:t}),ajax.del("/groups/"+e).then(function(){}.bind(this)).catch(function(e){console.log(e),displayError(e)}.bind(this)))},updateGroup:function(e){var t=e._id;this.timers[t]&&clearTimeout(this.timers[t]);var a=300;this.timers[t]=setTimeout(function(){delete this.timers[t],console.log("saving group...",e),ajax.put("/groups",e).then(function(){}.bind(this)).catch(function(e){console.log(e),displayError(e)}.bind(this))}.bind(this),a)},timers:{},handleCalendarSelection:function(e){var t=this.state.user;t.calendars=e,this.updateUser(t)},handleShareSelection:function(e){var t=this.state.user;t.share=e,this.updateUser(t)},loadGroups:function(){ajax.get("/groups").then(function(e){console.log("groups",e),this.setState({loading:!1,groups:e})}.bind(this)).catch(function(e){this.setState({loading:!1,groupsError:e}),console.log(e),displayError(e)}.bind(this))},loadCalendarList:function(){ajax.get("/calendar/").then(function(e){console.log("calendarList",e),this.setState({calendarList:e.items||[],calendarListLoading:!1,calendarListError:null})}.bind(this)).catch(function(e){this.setState({calendarListLoading:!1,calendarListError:e}),console.log(e),displayError(e)}.bind(this))},loadGroupsList:function(){ajax.get("/groups/list").then(function(e){console.log("groupsList",e),this.setState({groupsList:e})}.bind(this)).catch(function(e){console.log(e),displayError(e)}.bind(this))},getGroupOptions:function(){var e=this.props.user,t=this.state.groupsList;this.state.groups.forEach(function(a){if(a.group){var i=t.some(function(e){return e.name==a.group});i||t.push({name:a.group,count:1,members:[e.email]})}}.bind(this));var a=t.some(function(t){return t.name==e.email});return a||t.push({name:e.email,count:1,members:[e.email]}),t.map(function(e){return{value:e.name,text:e.name}}.bind(this))},updateUser:function(e){this.setState({user:e}),"function"==typeof this.props.onChange&&this.props.onChange(e)},deleteAccount:function(){confirm("Are you sure you want to delete your account?\n\nThis action cannot be undone.")&&ajax.del("/user/").then(function(){location.href="/"}).catch(function(e){console.log(e),displayError(e)})},showHelpBusy:function(e){e.preventDefault(),this.setState({showHelpBusy:!0})},showHelpAvailability:function(e){e.preventDefault(),this.setState({showHelpAvailability:!0})}});
