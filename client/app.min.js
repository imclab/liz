...
!function(t){t.sort=function(t){return t.sort(function(t,r){return t.start>r.start?1:t.start<r.start?-1:0}),t},t.merge=function(r){var e=r.slice(0);t.sort(e);for(var n=1;n<e.length;){var s=e[n-1],a=e[n];if(a.start<=s.end){var o={start:s.start,end:a.end>s.end?a.end:s.end};e.splice(n-1,2,o)}else n++}return e},t.invert=function(t,r,e){var n=[];if(void 0!=r&&t.length>0){var s=t[0].start;s>r&&n.push({start:r,end:s})}for(var a=1;a<t.length;a++){var o={start:t[a-1].end,end:t[a].start};if(o.start<o.end)n.push(o);else if(o.start>o.end)throw new Error("Overlapping intervals. Please sort and merge the intervals first.")}if(void 0!=e&&t.length>0){var d=t[t.length-1].end;e>d&&n.push({start:d,end:e})}return void 0!=r&&void 0!=e&&0==t.length&&n.push({start:r,end:e}),n},t.generateTimeslots=function(t,r){var e=[],n=moment();return r>0&&t.forEach(function(t){var s=moment(t.start),a=moment(t.end),o=s.clone();o.minutes()>0&&(o.minutes(0),o.add(1,"hour")),o.hour()%2==0&&o.add(1,"hour");for(var d=o.clone().add(r,"milliseconds"),i=36e5,l=2*i;d.valueOf()<=a.valueOf();)o>n&&o.day()==d.day()&&0!=o.day()&&6!=o.day()&&o.format("HH:mm:ss")>="09:00:00"&&d.format("HH:mm:ss")<="17:00:00"&&e.push({start:o.toISOString(),end:d.toISOString()}),o=o.add(l,"milliseconds"),d=o.clone().add(r,"milliseconds")}),e}}(function(){return"undefined"!=typeof exports?exports:window.intervals={}}());
...
function formatDate(e){return e?moment(e).format("YYYY-MM-DD"):null}function formatHumanDate(e){return e?moment(e).format("ddd DD MMM"):null}function formatTime(e){return e?moment(e).format("HH:mm:ss").replace(/(:00$)|(^00:00:00$)/,""):null}function displayError(e){var t=e&&e.message||e.toString(),n=document.createElement("div");n.className="alert alert-danger alert-dismissible",n.role="alert";var r=document.createElement("button");r.type="button",r.className="close",r["data-dismiss"]="alert",n.appendChild(r);var a=document.createElement("span");a["aria-hidden"]="true",a.innerHTML="&times",r.appendChild(a);var m=document.createElement("span");m.className="sr-only",m.innerHTML="Close";var o=document.createElement("strong");o.innerHTML="Error",n.appendChild(o),n.appendChild(document.createTextNode(" "+t));var l=document.getElementById("errors");l.appendChild(n),r.onclick=function(){l.removeChild(n)}}
