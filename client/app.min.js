...
var ajax=function(){function e(e,t,n,r){return new Promise(function(o,s){try{var a=new XMLHttpRequest;if(a.onreadystatechange=function(){try{if(4==a.readyState)if(console.log("ready",t,a),0==a.status)console.log("reject"),s(new Error("Connection failed"));else{var e=a.getResponseHeader("content-type");e&&0==e.toLowerCase().indexOf("application/json")?o(JSON.parse(a.responseText),a.status,a):o(a.responseText,a.status,a)}}catch(n){s(n)}},a.open(e,t,!0),r)for(var i in r)r.hasOwnProperty(i)&&a.setRequestHeader(i,r[i]);"string"==typeof n?a.send(n):(a.setRequestHeader("Content-Type","application/json"),a.send(JSON.stringify(n)))}catch(c){s(c)}})}function t(t,n){return e("GET",t,"",n)}function n(t,n,r){return e("POST",t,n,r)}function r(t,n,r){return e("PUT",t,n,r)}function o(t,n){return e("DELETE",t,"",n)}return{fetch:e,get:t,post:n,put:r,del:o}}();
...
var App=React.createClass({displayName:"App",getInitialState:function(){return this.loadUser(),{user:null,page:hash.get("page")||"home"}},render:function(){var e,a=this.state.user,t=Menu({ref:"menu",user:a,page:this.state.page,onPage:this.handlePageChange});if(a&&1==a.loggedIn)switch(this.state.page){case"settings":e=SettingsPage({ref:"page",user:this.state.user,onChange:this.handleUserChange});break;case"calendar":e=CalendarPage({ref:"page",user:this.state.user});break;default:e=HomePage({ref:"page",user:this.state.user})}else e=a&&0==a.loggedIn?React.DOM.div(null,React.DOM.h1(null,"Sign in to get started..."),React.DOM.p(null,React.DOM.a({href:"/user/signin?redirectTo="+encodeURIComponent(location.href),className:"btn btn-primary"},"Sign in"))):React.DOM.div(null,"loading ",React.DOM.img({className:"loading",src:"img/ajax-loader.gif"}));return React.DOM.div(null,t,e)},handlePageChange:function(e){hash.set("page",e),this.setState({page:e})},handleUserChange:function(e){console.log("Changed user:",e),this.setState({user:e}),ajax.put("/user/",e).then(function(e){console.log("user",e),this.setState({user:e})}.bind(this)).catch(function(e){console.log("Error",e),displayError(e)})},loadUser:function(){ajax.get("/user/").then(function(e){console.log("user",e),this.setState({user:e})}.bind(this)).catch(function(e){console.log("Error",e),displayError(e)})}});
