  ...
  if (calendar) {
    ...
    try {
      var events = params.days.map(function (day) {
        ...
        console.log('params.zone', params.zone)

        console.log('availability events start.toISOString():' + start.toISOString())
        console.log('availability events start.format():' + start.format())
