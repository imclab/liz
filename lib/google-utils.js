  ...
  if (calendar) {
    ...
    try {
      var events = params.days.map(function (day) {
        ...
        console.log('availability events start.toISOString():' + moment(getDate(day.day) + 'T' + formatTime(day.start))
            .zone(params.zone).toISOString())
        console.log('availability events start.format():' + moment(getDate(day.day) + 'T' + formatTime(day.start))
            .zone(params.zone).format())
